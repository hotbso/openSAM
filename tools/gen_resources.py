...
t2_tmpl_obj = "../DGS-Safedock-T2-24/Safedock-T2-24.obj"
t2_tmpl_obj_pole = "../DGS-Safedock-T2-24/Safedock-T2-24-pole.obj"

# for library objects
lib_tex_files = ["../DGS-Safedock-T2-24/Safedock-T2-24.png", "../DGS-Safedock-T2-24/Safedock-T2-24_NML.png",
...
# everything that gets instanced
resource_files = lib_tex_files + [
            "../DGS-Safedock-T2-24/Safedock-T2-24-display.obj", "../DGS-Safedock-T2-24/Safedock-T2-24-display_LIT.png",
            "../DGS-Safedock-T2-24/Safedock-T2-24.obj", "../DGS-Safedock-T2-24/Safedock-T2-24-pole.obj",

            "../DGS-Safedock-T2-24/pole_base.obj", "../DGS-Safedock-T2-24/pole_base.png",

            "../DGS-Safedock-X/Safedock-X-display.obj", "../DGS-Safedock-X/Safedock-X-idle.obj",
            "../DGS-Safedock-X/Safedock-X-display_LIT.png",
            "../DGS-Safedock-X/Safedock-X.obj", "../DGS-Safedock-X/Safedock-X-pole.obj"]
...
gen_variant("../DGS-Safedock-X/Safedock-X.obj", fn, 0)
gen_files.append(fn)

fn = f"{target_dir_lib}/dgs/Safedock-X-pole.obj"
gen_variant("../DGS-Safedock-X/Safedock-X-pole.obj", fn, 0)
gen_files.append(fn)
